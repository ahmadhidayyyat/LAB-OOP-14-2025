...
import model_app.Profile;
import model_app.User;
...
public class Main {
    ...
    private static void showLoginMenu() {
        ...
        while (username.isEmpty()){
            System.out.println("ERROR: Username Harus Terisi");
            username = sc.next();
        }
        ...
        if (userIndex != -1) {
            ...
            if (isPasswordMatch) {
                 ...
                 * 
                 */
                showDetailUser(listUser.get (userIndex).profile );
                System.exit(0);
            } else {
    ...
    private static void showRegisterMenu() {
        ...
        while (usernameTerpakai(username)){
